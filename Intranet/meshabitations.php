...
<html lang="en-US">
    ...
    <body class="home blog">
            ...
            <div class="menu-right-part">
                ...
                <div class="social-holder">
                    <div class="social-list">
                        <a href="meshabitations"><i class="fa fa-twitter"><br/>Mes habitations</i></a>
                        <a href="mespoubelles"><i class="fa fa-youtube-play"><br/>Mes poubelles</i></a>
                        <a href="leslevees"><i class="fa fa-facebook"><br/>Les levées</i></a>
                        <a href="lestypesdechets"><i class="fa fa-vimeo"><br/>Les types de déchets</i></a>
                    </div>
                </div>
        ...
        <!-- Home Content -->
                                <?php
                                if (isset($_GET["action"]) && isset($_GET["idH"]))
                                {
                                    $action = $_GET["action"];
                                    $idH = $_GET["idH"];
                                    if ($action == "X")
                                    {
                                        deleteHabitationC($idH);
                                    }
                                    else if ($action == "E")
                                    {
                                        $resultat = selectWhereIdHabitationC($idH);
